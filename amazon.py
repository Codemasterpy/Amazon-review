...
st.markdown(
"We are going to analyse amazon review, based on genuine and not genuine.")
...
st.markdown("<h3 style='text-align: center; color: #4374B3;'>Comparision of Reviews:</h2>", unsafe_allow_html=True)


sns.set(font_scale=1.4, style="whitegrid")
df2['Overall_Sentiment'].value_counts().plot(kind='bar', figsize=(7, 6), rot=0)
plt.xlabel("Sentiments", labelpad=14)
plt.ylabel("Count of People", labelpad=14)
plt.title("Count of People Whos Sentiments is Analysed", y=1.02);
...
st.markdown("<h3 style='text-align: center; color: #4374B3;'>Reviews Rating Comparison:</h2>", unsafe_allow_html=True)
